...
async def get_settings():
    ...
    return {
        ...
        "vision_llm_enabled": settings.vision_llm_enabled,
        "vision_llm_api_base_url": settings.vision_llm_api_base_url or "",
        "vision_llm_api_key_set": bool(settings.vision_llm_api_key),
        "vision_llm_model_name": settings.vision_llm_model_name or "",
        "vision_llm_context_window": settings.vision_llm_context_window,
